...
const aliment = await allAliments(props.id);
</script>

<template>
    <div class="flex items-center flex-row ">
      <h1 class="text-green-dull font-medium text-4xl">Citrons jaunes</h1> 
    ...
    <section class="grid grid-cols-12 gap-4 ">
      <section class="col-start-3 col-end-9 shadow-card-shadow flex flex-col w-full  ">
        <div class="bg-image-cover-produit w-full h-96">
        </div>
        <section class="p-6">
        ...
        <div class="flex flex-row  items-center justify-between ">
          ...
          <div><RouterLink class="text-xs font-poppins text-beige bg-green-dull ml-6 rounded-full px-3 py-1 font-light " to="contact">Contacter</RouterLink></div>
        </div>
        <div class="flex flex-row gap-4">
        <img class="w-6" src="@/assets/icones/icon-social-facebook.svg" alt=""><img class="w-6" src="@/assets/icones/icon-social-instagram.svg" alt=""><img class="w-6" src="@/assets/icones/icon-social-twitter.svg" alt=""><img class="w-6" src="@/assets/icones/icon-link.svg" alt="">
      </div>
      </div>
  ...
  <img class="aspect-square w-24 m-1" src="@/assets/image-citrons.webp" alt=""><img class="aspect-square w-24 m-1" src="@/assets/image-cerises.webp" alt=""><img class="aspect-square w-24 m-1" src="@/assets/image-painchocolat.webp" alt=""><img class="aspect-square w-24 m-1" src="@/assets/image-carottes.webp" alt=""><img class="aspect-square w-24 m-1" src="@/assets/image-pommes.webp" alt=""><img class="aspect-square w-24 m-1" src="@/assets/image-pain.webp" alt="">
        ...
        <RouterLink class="text-beige font-normal m-auto w-fit text-xs mb-5 px-3 py-[0.5px] bg-green-dull rounded-full" to="Profilpage"> Voir le profil</RouterLink>
      </div>
      </section>
    </section>
  </template>
