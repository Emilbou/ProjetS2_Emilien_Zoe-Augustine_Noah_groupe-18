        ...
        <nav class="bg-beige border-gray-200 px-4 lg:px-6 py-2.5">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                <a href="/" class="flex items-center">
                    <img src="src/assets/Place_des_saveurs_logo.webp" class="mr-3 h-20 sm:h-9" alt="place des saveurs Logo" />
                </a>
                <div class="flex items-center lg:order-2">
                    <RouterLink to="/Profilpage" class="text-gray-800  hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2  focus:outline-none ">profil </RouterLink>
